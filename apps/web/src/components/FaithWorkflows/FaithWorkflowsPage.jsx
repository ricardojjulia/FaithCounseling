 ...
 *   sharedUrgencyCounts — canonical urgency totals from the operations summary
 */
export default function FaithWorkflowsPage({ clients = [], currentUser, sharedUrgencyCounts = null }) {
  const { t } = useI18n();
  ...
  }, [localUrgencyCounts, sharedUrgencyCounts]);
