...
async function insertClientBundle(connection, dataset, client, hashes) {
  ...
  await connection.query(
    ...
    [
      ...
      encrypt(client.guardianName ? `${client.addressLine1}, ${client.city}, ${client.state} ${client.postalCode}` : null),
      client.isMinor ? 1 : 0,
      encrypt(client.isMinor ? `COURT-${client.id.toUpperCase()}` : null),
      encrypt(client.isMinor ? JSON.stringify({ contact: 'School support team', phone: '555-999-1100' }) : null),
